...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {{ Form::textarea('comment', $planet ? $planet->comment : null, array('class' => 'form-control bbeditor')) }}
        <br/>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        @if($planet)
            @if($planet->image)
                <img src="/img/uploads/{{$planet->image}}" style="max-width: 100px; margin-bottom: 15px;"
                     class="img-rounded">
            @endif
